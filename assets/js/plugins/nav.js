...
/***/ "./javascript/plugins/nav/classes/Nav.tsx":
/*!************************************************!*\
  !*** ./javascript/plugins/nav/classes/Nav.tsx ***!
  \************************************************/
/*! no static exports found */
...
var Nav = /** @class */ (function () {
    ...
    Nav.prototype.goTo = function (path) {
        if (path === void 0) { path = "/"; }
        if (this.ljs.cfg("pjax-container")) {
            $.pjax({ url: path, container: this.ljs.cfg("pjax-container") });
        }
        else {
    ...
    Nav.prototype.change_url = function (url, title, data) {
        ...
        if (typeof title === 'object') {
            var params = decodeURI(jQuery.param(title));
            if (params) {
                url = url + "?" + params;
            }
        }
        var dataState;
        if (data) {
            dataState = merge_1.default(data, window.$state.all());
        }
        else {
    ...
    Nav.prototype._configure = function () {
        $.pjax.defaults.timeout = 5000;
        $.pjax.defaults.maxCacheLength = 0;
        return this;
    };
    Nav.prototype._set_events = function () {
        var _this = this;
        if (!('$' in window)) {
            return;
        }
        ...
        $(document).on('submit', 'form:not([target]):not([tabindex])', function (event) {
        ...
        $(document).on('pjax:timeout', function (event) {
            ...
            if (true) {
                _this.ljs._warn("Pjax TimeOut:", event);
            }
        });
        ...
        $(document).on('pjax:send', function (xhr) {
            _this.ljs.progress.start();
            document.body.style.cursor = "progress";
            _this.ljs.switchProcess(true);
        ...
        $(document).on('pjax:complete', function (xhr, req, status) {
            ...
            _this.ljs.progress.done();
            _this.ljs._dispatch_event("ljs:nav:complete", { nav: _this, req: req, xhr: xhr, container: obj });
        });
        $(document).on('pjax:error', function (xhr, textStatus, error, options) {
            document.body.style.cursor = "auto";
            _this.ljs.progress.done();
            _this.ljs.switchProcess(false);
            _this.ljs._dispatch_event("ljs:nav:error", { nav: _this, xhr: xhr, textStatus: textStatus, error: error, options: options });
        });
        return this;
    };
    return Nav;
...
/***/ "./javascript/plugins/nav/nav.tsx":
/*!****************************************!*\
  !*** ./javascript/plugins/nav/nav.tsx ***!
  \****************************************/
/*! no static exports found */
...
var Nav_1 = __webpack_require__(/*! ./classes/Nav */ "./javascript/plugins/nav/classes/Nav.tsx");
__webpack_require__(/*! ./plugins/jquery.lar.pjax */ "./javascript/plugins/nav/plugins/jquery.lar.pjax.js");
Helper_1.Helper.before_load(function (ljs) {
    ljs.$nav = new Nav_1.Nav(ljs);
    window.$nav = ljs.$nav;
});
...
/***/ "./javascript/plugins/nav/plugins/jquery.lar.pjax.js":
/*!***********************************************************!*\
  !*** ./javascript/plugins/nav/plugins/jquery.lar.pjax.js ***!
  \***********************************************************/
/*! no static exports found */
...
(function ($) {
  ...
  function pjax(options) {
    ...
    options.success = function (data, status, xhr) {
      ...
      this.cancelContext = function () {
        var bool = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        _this.cancel_context = bool !== null ? bool : true;
        return _this.cancel_context;
      };
...
/***/ 2:
/*!**********************************************!*\
  !*** multi ./javascript/plugins/nav/nav.tsx ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
