...
/***/ "./javascript/plugins/model/BaseModel.tsx":
/*!************************************************!*\
  !*** ./javascript/plugins/model/BaseModel.tsx ***!
  \************************************************/
...
var Builder_1 = __webpack_require__(/*! ./Builder */ "./javascript/plugins/model/Builder.tsx");
var pluralize = __webpack_require__(/*! pluralize */ "./node_modules/pluralize/pluralize.js");
var BaseModel = /** @class */ (function () {
    function BaseModel(attributes) {
        var _this = this;
        if (attributes === void 0) { attributes = {}; }
        Object.keys(this.constructor.attributes).map(function (key) {
            _this.constructor.attributes[key] =
                _this.constructor.__make_cast(key, _this.constructor.attributes[key]);
        });
        Object.keys(attributes).map(function (key) {
            _this.constructor.attributes[key] =
                _this.constructor.__make_cast(key, attributes[key]);
        });
        this.constructor.builder = new Builder_1.Builder(this.constructor);
        return this.constructor.proxy = new Proxy(this, {
            get: this.constructor.__get,
            set: this.constructor.__set
        });
    }
    BaseModel.__getTable = function (singular) {
        if (!this.table) {
            throw new Error("Set table in Model");
        }
        return pluralize(this.table, singular ? 1 : 0);
    };
    BaseModel.__get = function (target, prop) {
        ...
        var mutatorName = window.ljs.help.camelize("get_" + prop + "_attribute");
    ...
    BaseModel.__make_cast = function (name, value) {
        var cast = null;
    ...
    BaseModel.__set = function (target, prop, value, proxy) {
        var mutatorName = window.ljs.help.camelize("set_" + prop + "_attribute");
        if (Reflect.has(target, mutatorName)) {
    ...
    BaseModel.endpoint = 'graphql';
    BaseModel.attributes = {};
    BaseModel.guarded = [];
    BaseModel.fillable = ['id'];
    BaseModel.appends = [];
    BaseModel.casts = {};
    BaseModel.times = ['created_at', 'updated_at', 'deleted_at'];
    return BaseModel;
}());
...
/***/ "./javascript/plugins/model/Builder.tsx":
/*!**********************************************!*\
  !*** ./javascript/plugins/model/Builder.tsx ***!
  \**********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var collect_js_1 = __importDefault(__webpack_require__(/*! collect.js */ "./node_modules/collect.js/dist/index.js"));
var Builder = /** @class */ (function () {
    function Builder(model, related) {
        if (related === void 0) { related = false; }
        this.constructor.model = model;
        this.constructor.directives = {};
        this.constructor.related = related;
    }
    Builder.prototype.find = function (id, fields) {
    ...
    Builder.prototype.endpoint = function () {
        var model = this.constructor.model;
        return window.location.origin + '/' + model.endpoint.trim('/');
    };
    Builder.prototype.directive = function (key, value) {
        this.constructor.directives[key] = value;
        return this;
    };
    ...
    Object.defineProperty(Builder.prototype, "buildQuery", {
        get: function () {
            return this.constructor.buildQuery;
        },
        enumerable: true,
        configurable: true
    });
    Builder.prototype.makeRequest = function (query) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            xhr.onload = function (e) {
                ...
                if (target.status >= 200 && target.status < 300) {
                    resolve(_this.constructor.makeResult(JSON.parse(target.response)));
                }
                else {
    ...
    Builder.makeResult = function (data) {
        var _this = this;
        if ('data' in data) {
            var model = this.model;
            var singular = this.singular;
            var table = model.__getTable(singular);
            if (table in data.data) {
                var results = data.data[table];
                if (!singular) {
                    return collect_js_1.default(results.data.map(function (items) {
                        return (new _this.model(items)).toJson();
                    }));
                }
    ...
    Builder.buildQuery = function (fields) {
        if (fields === void 0) { fields = null; }
        var model = this.constructor.model;
        var directives = this.constructor.directives;
        var related = this.constructor.related;
        var singular = this.constructor.singular;
        fields = fields === null ? model.fillable.join(',') : fields.join(',');
        fields = singular ? "{" + fields + "}" : "{data{" + fields + "}}";
        var dirs = [];
        Object.keys(directives).map(function (key) { dirs.push(key + ":" + directives[key]); });
        dirs = dirs.join(',');
        dirs = dirs ? "(" + dirs + ")" : dirs;
        var query = "{" + model.__getTable(singular) + dirs + fields + "}";
...
var _a;
Object.defineProperty(exports, "__esModule", { value: true });
var BaseModel_1 = __webpack_require__(/*! ./BaseModel */ "./javascript/plugins/model/BaseModel.tsx");
window.Model = /** @class */ (function (_super_1) {
    __extends(Model, _super_1);
    function Model() {
    ...
    Model.prototype.toJson = function () {
        ...
        Object.keys(constructor.attributes).map(function (key) {
            if (constructor.guarded.indexOf(key) === -1) {
                result[key] = _this[key];
            }
        });
        constructor.appends.map(function (key) {
            result[key] = _this[key];
        });
        return result;
    };
    ...
    Model.prototype.query = function () {
        return this._super.builder;
    };
    Model.prototype.find = function (id, fields) {
        if (fields === void 0) { fields = null; }
        return this.query().find(id, fields);
    };
    Model.prototype.get = function (fields) {
        if (fields === void 0) { fields = null; }
        return this.query().get(fields);
    };
    Model.prototype.paginate = function (limit, page, fields) {
        if (limit === void 0) { limit = 10; }
        if (page === void 0) { page = 1; }
        if (fields === void 0) { fields = null; }
...
window.User = (_a = /** @class */ (function (_super_1) {
        __extends(User, _super_1);
        function User() {
            return _super_1 !== null && _super_1.apply(this, arguments) || this;
        }
        return User;
