...
/***/ "./javascript/plugins/alert/Executors/Errors.tsx":
/*!*******************************************************!*\
  !*** ./javascript/plugins/alert/Executors/Errors.tsx ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./javascript/plugins/alert/Executors/Message.tsx":
/*!********************************************************!*\
  !*** ./javascript/plugins/alert/Executors/Message.tsx ***!
  \********************************************************/
/*! no static exports found */
...
/***/ "./javascript/plugins/alert/Executors/Swal.tsx":
/*!*****************************************************!*\
  !*** ./javascript/plugins/alert/Executors/Swal.tsx ***!
  \*****************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var ExecutorParent_1 = __webpack_require__(/*! ../../../ljs/Extends/ExecutorParent */ "./javascript/ljs/Extends/ExecutorParent.tsx");
var Swal = /** @class */ (function (_super) {
    __extends(Swal, _super);
    function Swal() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Swal.prototype.input = function (title, exec) {
        ...
        return window.ljs.swal.fire({
            ...
            if (exec) {
                window.ljs.exec(exec, state.value, _this.storage);
            }
            return state;
        });
    };
    Swal.prototype.confirm = function (title, success, cancel, options) {
        var _this = this;
    ...
    Swal.prototype.success = function (title, text, options) {
        if (text === void 0) { text = ''; }
        if (options === void 0) { options = {}; }
        return window.ljs.swal.fire(__assign({ title: title, text: text, type: 'success' }, options));
    };
    Swal.prototype.warning = function (title, text, options) {
        if (text === void 0) { text = ''; }
        if (options === void 0) { options = {}; }
        return window.ljs.swal.fire(__assign({ title: title, text: text, type: 'warning' }, options));
    };
    Swal.prototype.error = function (title, text, options) {
        if (text === void 0) { text = ''; }
        if (options === void 0) { options = {}; }
        return window.ljs.swal.fire(__assign({ title: title, text: text, type: 'error' }, options));
    };
    Swal.prototype.info = function (title, text, options) {
        if (text === void 0) { text = ''; }
        if (options === void 0) { options = {}; }
        return window.ljs.swal.fire(__assign({ title: title, text: text, type: 'info' }, options));
    };
    Swal.prototype.question = function (title, text, options) {
        if (text === void 0) { text = ''; }
        if (options === void 0) { options = {}; }
        return window.ljs.swal.fire(__assign({ title: title, text: text, type: 'question' }, options));
    };
...
/***/ "./javascript/plugins/alert/Executors/Toast.tsx":
/*!******************************************************!*\
  !*** ./javascript/plugins/alert/Executors/Toast.tsx ***!
  \******************************************************/
/*! no static exports found */
...
var Toast = /** @class */ (function (_super) {
     ...
     * @private
     */
    Toast._send = function (message, title, options, type) {
        if (title === void 0) { title = null; }
        if (options === void 0) { options = {}; }
        if (type === void 0) { type = "info"; }
        if (typeof message === 'string') {
            window.ljs.toast[type](message, title, options);
            ...
            if (message["title"] !== undefined && message["text"] !== undefined) {
                ...
                map_1.default(message, function (item, key) {
                    var _a;
                    if (window.ljs.toast[key] === undefined) {
                        key = type;
                    }
...
/***/ "./javascript/plugins/alert/alert.tsx":
/*!********************************************!*\
  !*** ./javascript/plugins/alert/alert.tsx ***!
  \********************************************/
/*! no static exports found */
...
var Toast_1 = __webpack_require__(/*! ./Executors/Toast */ "./javascript/plugins/alert/Executors/Toast.tsx");
var Swal_1 = __webpack_require__(/*! ./Executors/Swal */ "./javascript/plugins/alert/Executors/Swal.tsx");
var Message_1 = __webpack_require__(/*! ./Executors/Message */ "./javascript/plugins/alert/Executors/Message.tsx");
var Errors_1 = __webpack_require__(/*! ./Executors/Errors */ "./javascript/plugins/alert/Executors/Errors.tsx");
Helper_1.Helper.before_load(function (ljs) {
    ljs.toast = __webpack_require__(/*! toastr */ "./node_modules/toastr/toastr.js");
    ljs.swal = __webpack_require__(/*! sweetalert2/dist/sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.js");
    ljs
        .regExec(Message_1.Message)
        .regExec(Errors_1.Errors)
        .regExec(Toast_1.Toast)
        .regExec(Swal_1.Swal);
});
...
/***/ 4:
/*!**************************************************!*\
  !*** multi ./javascript/plugins/alert/alert.tsx ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
