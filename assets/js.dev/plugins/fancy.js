...
Helper_1.Helper.before_load(function (ljs) {
    var FancyBox = /** @class */ (function (_super) {
        __extends(FancyBox, _super);
        function FancyBox() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        FancyBox.prototype.mess = function (items, opts, index) {
            return $.fancybox.open(items, opts, index);
        };
        FancyBox.prototype.img = function (img, opts) {
            if (opts === void 0) { opts = null; }
            return $.fancybox.open({
                src: img,
            }, opts);
        };
        FancyBox.prototype.imgs = function () {
            var args = [];
