...
/***/ "./javascript/plugins/vue/VueExecutor.tsx":
/*!************************************************!*\
  !*** ./javascript/plugins/vue/VueExecutor.tsx ***!
  \************************************************/
/*! no static exports found */
...
var VueExecutor = /** @class */ (function (_super) {
    __extends(VueExecutor, _super);
    ...
    VueExecutor.prototype.init = function () {
        if (this.target) {
            ...
            if (this.target.hasAttribute('id')) {
                name_1 = this.target.getAttribute('id');
            }
            var vue = new window.ljs.vue({
                el: this.target,
                data: function () {
                    return {
                        ljs: window.ljs,
            ...
            if (window.ljs.$vue[group_1] === undefined) {
                window.ljs.$vue[group_1] = {};
            }
...
exports.VueExecutor = VueExecutor;


/***/ }),

/***/ "./javascript/plugins/vue/vue.tsx":
/*!****************************************!*\
  !*** ./javascript/plugins/vue/vue.tsx ***!
  \****************************************/
/*! no static exports found */
...
var VueExecutor_1 = __webpack_require__(/*! ./VueExecutor */ "./javascript/plugins/vue/VueExecutor.tsx");
...
Helper_1.Helper.before_load(function (ljs) {
    ...
    ljs.$vue = {
        ...
        pjaxComponents: function () {
            var group = ljs.$vue.group();
            return ljs.$vue[group] !== undefined ? ljs.$vue[group] : {};
        },
        allComponents: function () {
            return merge_1.default(ljs.$vue.getComponents(), ljs.$vue.pjaxComponents());
        },
        destroy: function ($name, $group) {
            if ($group === void 0) { $group = 'auto'; }
            if ($group === 'auto') {
                $group = ljs.$vue.group();
            }
        ...
        destroyGroup: function ($group) {
            if (ljs.$vue[$group] !== undefined) {
                var result = filter_1.default(ljs.$vue[$group], function (vm, name) {
        ...
        unset: function ($path) {
            return unset_1.default(ljs.$vue, $path);
        }
    };
    ljs.regExec(VueExecutor_1.VueExecutor);
    ljs.vue.mixin({
        data: function () {
            return {
                ljs: ljs
...
/***/ 1:
/*!**********************************************!*\
  !*** multi ./javascript/plugins/vue/vue.tsx ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/xsaven/PhpstormProjects/scrap/vendor/lar/ljs/javascript/plugins/vue/vue.tsx */"./javascript/plugins/vue/vue.tsx");
