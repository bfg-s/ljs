...
Helper_1.Helper.before_load(function (ljs) {
    var jQuery = /** @class */ (function (_super) {
        __extends(jQuery, _super);
        function jQuery() {
         ...
         * @private
         */
        jQuery.prototype._select = function ($select) {
         ...
         * @private
         */
        jQuery.prototype.__call = function ($name, $args) {
            var _a;
            if ($args.length && $args[0] !== undefined) {
                var a_1 = [], select = this._select($args[0]);
                map_1.default($args, function (i, k) { return k && a_1.push(i); });
                return (_a = $(select))[$name].apply(_a, a_1);
            }
            if (true) {
         ...
         * @param $data
         */
        jQuery.prototype.manyAttributes = function ($data) {
            return map_1.default($data, function ($data, $selector) {
                return map_1.default($data, function ($value, $name) {
         ...
         * @param $val
         */
        jQuery.prototype.attribute = function ($selector, $attr, $val) {
         ...
         * @param $attributes
         */
        jQuery.prototype.attr_merge = function ($selector, $attributes) {
            return map_1.default($attributes, function (i, k) {
         ...
         * @param data
         */
        jQuery.prototype.globalEval = function (data) {
...
module.exports = __webpack_require__(/*! /Users/xsaven/PhpstormProjects/scrap/vendor/lar/ljs/javascript/plugins/jq.tsx */"./javascript/plugins/jq.tsx");
